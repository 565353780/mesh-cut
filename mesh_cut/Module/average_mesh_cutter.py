...
class AverageMeshCutter(object):
    def __init__(
        self,
    ...
    def isValid(self) -> bool:
        return self.vertices.size > 0 and self.triangles.size > 0
    ...
    def loadMesh(
        ...
        if not os.path.exists(mesh_file_path):
            print("[ERROR][AverageMeshCutter::loadMesh]")
